              ...
              return Padding(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return CustomCard(
                      image: state.favList[index]["product"].image,
                      name: state.favList[index]["product"].name,
                      onTap: () {
                        push(context,
                            page: ProductDetails(
                                product: state.favList[index]["product"]));
                      },
                      price: "\$ ${state.favList[index]["product"].price}",
                    );
                  },
                ),
              );
